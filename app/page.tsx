...
export const metadata = generateSEO({
  ...
  description:
    "Schoolfee help middle-class families pay school fees on time with a 2–3 month interest-free repayment, ensuring uninterrupted education and mental well-being.",
  keywords: [
    "School Fee Support",
