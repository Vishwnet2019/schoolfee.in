...
export default function SchoolFeeContent() {
  ...
  return (
    <div className="w-full bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/2 space-y-4 md:space-y-5">
              ...
              <p className="lg:text-xl text-md md:text-base text-gray-700 leading-relaxed">
                Through our initiative, parents can repay the supported fee amount within 2 to 3 months, completely <strong className="text-[#0cab47]">interest-free</strong>, and without any extra charges.
              </p>
            ...
            <div className="w-full lg:w-1/2 relative">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-[#00468e] to-[#003366] rounded-2xl md:rounded-3xl p-4 md:p-3 shadow-xl">
                  <img
                    src="/home-page/What is Schoolfee.webp"
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-6 md:gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/2 relative">
              <div className="relative">
                ...
                <img
                  src="/home-page/Schoolfee Our Mission.webp"
      ...
      <section className="bg-[#00468e] relative overflow-hidden px-2 py-8">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white mb-3 md:mb-4 leading-tight">
