          ...
          <div className="flex justify-center gap-3 md:gap-3 lg:gap-4 mb-8 md:mb-10 lg:mb-12">
            {['mission', 'vision', 'values'].map((tab) => (
              <button
                ...
                className={`px-4 py-2 md:px-6 md:py-2.5 lg:px-8 lg:py-3 rounded-full font-bold text-xs md:text-sm lg:text-base xl:text-lg transition-all duration-300 whitespace-nowrap ${
                  activeTab === tab
