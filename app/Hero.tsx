...
export default function Hero() {
  return (
    <section className="relative w-full flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#00468e] to-[#003366] py-20 lg:py-16">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 text-left lg:text-left space-y-4">
            ...
            <div className="text-base sm:text-lg md:text-xl text-blue-100 font-light max-w-4xl">
              <p>
                Schoolfee is a Health Financial Inclusion Program, a collaborative initiative of Community Health Mission (CHM) and India Health Fund Limited. Our platform is designed to support middle-class Lower Income Group families who face temporary financial challenges in paying their children’s school fees on time.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row gap-4">
              ...
              <Link
                href="/registration"
                className="inline-flex justify-center items-center gap-3 px-8 py-4 text-lg font-bold text-white bg-[#f4951d] rounded-full shadow-lg hover:bg-[#d68118]"
              >
                Start Registration <FaArrowRight />
              </Link>
